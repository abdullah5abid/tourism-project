...
def hotelform(request):
    if request.method == 'POST':
        ...
        furnitures = zip(data.getlist('bedroomType'), data.getlist('roomType'), data.getlist('corridors'), data.getlist('attachedBathroom'), data.getlist('commonBathroom'), data.getlist('commonToilet'), data.getlist('cuisineName'))
